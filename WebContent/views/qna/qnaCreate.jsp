            ...
            <div id="detail_box">
                ...
                <table class="table">
                    <tr>
                        ...
                        <th width=10%>작성일자</th>
                        <td id="date2" width="10%"><%= sf.format(nowTime) %></td>
                    </tr>
                    <tr>
                        <th>제목</th>
                        <td colspan="3"><input type="text" name="title" placeholder="제목을 입력해주세요" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm"></td>
                    </tr>
                    <tr>
                        <th>내용</th>
                        <td colspan="3">
                            <div id="notice_contents">
                                <textarea class="form-control" name="content" placeholder="내용을 입력해주세요" id="floatingTextarea2" style="height: 100%"></textarea>
                            </div>
                        </td>
                    </tr>
